...
[![Build Status](https://travis-ci.org/TheArcadiaGroup/firowallet.png?branch=master)](https://travis-ci.org/TheArcadiaGroup/firowallet)
...
can be found [here](https://github.com/TheArcadiaGroup/firod).  An alternative
...
https://github.com/TheArcadiaGroup/firowallet/releases
...
```bash
$ cd $GOPATH/src/github.com/TheArcadiaGroup/firowallet
...
```bash
$ cp $GOPATH/src/github.com/TheArcadiaGroup/firod/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/TheArcadiaGroup/firowallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/TheArcadiaGroup/firowallet/issues)
