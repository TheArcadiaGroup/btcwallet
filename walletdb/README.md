...
[![GoDoc](https://godoc.org/github.com/TheArcadiaGroup/firowallet/walletdb?status.png)]
(http://godoc.org/github.com/TheArcadiaGroup/firowallet/walletdb)
...
http://localhost:6060/pkg/github.com/TheArcadiaGroup/firowallet/walletdb

## Installation

```bash
$ go get github.com/TheArcadiaGroup/firowallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/TheArcadiaGroup/firowallet/walletdb#example-package--BasicUsage)  
